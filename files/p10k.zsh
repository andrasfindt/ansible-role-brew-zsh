# Generated by Powerlevel10k configuration wizard on 2020-08-24 at 18:19 SAST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_LEFT_WHITESPACE=' '  # no surrounding whitespace
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=117
  ...
  #
    typeset -g POWERLEVEL9K_DIR_SBG_FOREGROUND=33
    typeset -g POWERLEVEL9K_DIR_SBG_SHORTENED_FOREGROUND=75
    typeset -g POWERLEVEL9K_DIR_SBG_ANCHOR_FOREGROUND=21
  #
  # typeset -g POWERLEVEL9K_DIR_CLASSES=()
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    '~/Development/sbg(/*)#'  SBG   '\uF19C'
